...
import createEmailTemplateRouter from "./EmailTemplate.router";
import createEmailRouter from "./Email.router";
import createEmailRecipientRouter from "./EmailRecipient.router";
...
import { ClientType as EmailTemplateClientType } from "./EmailTemplate.router";
import { ClientType as EmailClientType } from "./Email.router";
import { ClientType as EmailRecipientClientType } from "./EmailRecipient.router";
...
export function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        emailTemplate: createEmailTemplateRouter(router, procedure),
        email: createEmailRouter(router, procedure),
        emailRecipient: createEmailRecipientRouter(router, procedure),
...
export interface ClientType<AppRouter extends AnyRouter> {
    ...
    emailTemplate: EmailTemplateClientType<AppRouter>;
    email: EmailClientType<AppRouter>;
    emailRecipient: EmailRecipientClientType<AppRouter>;
